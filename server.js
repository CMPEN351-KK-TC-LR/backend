...
// Create factory function to avoid caching per guide here: https://glebbahmutov.com/blog/how-to-correctly-unit-test-express-server/
const createServer = () => {
    ...
    mongoose.connect(process.env.MONGODB_URI)
        .then(() => {
            ...
            return server // so we can use it in tests
        })
        .catch((err) => {
            console.log(err)
        })
...
module.exports = createServer // So we can create a new server for each test
